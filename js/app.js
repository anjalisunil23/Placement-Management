...
function enforcePageRole(active) {
  if (!active || active === 'login.html' || active === PORTAL_AUTH_PAGE || active === 'public-stats.html' || active === 'index.html') return true;
...
document.addEventListener("DOMContentLoaded", async () => {
  ...
  const isPublic = !active || active === 'login.html' || active === PORTAL_AUTH_PAGE || active === 'public-stats.html' || active === 'index.html' || active === 'register.html';
