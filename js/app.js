...
const NAV = [
  ...
  { href: "internal-jobs.html", icon: "bi-briefcase", label: "Internal Jobs", roles: ['student'], studentOnly: true },
  ...
  { href: "internal-jobs.html", icon: "bi-briefcase", label: "Internal Job Posts", roles: ['admin', 'placement_officer'] },
