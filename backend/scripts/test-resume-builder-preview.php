...
$assert(str_contains($settings, 'resume-builder.css?v=20260824rb17'), 'CSS cache bust');
$assert(str_contains($settings, 'resume-builder.js?v=20260824rb17'), 'JS cache bust');
