...
$assert(str_contains($js, 'educationProgramYears'), 'program year-length helper');
...
$assert(str_contains($settings, 'resume-builder.css?v=20260824rb18'), 'CSS cache bust');
$assert(str_contains($settings, 'resume-builder.js?v=20260824rb18'), 'JS cache bust');
