...
$assert(!str_contains($service, 'use TCPDF'), 'TCPDF not used for resume PDF');
...
$assert(str_contains($settings, 'resume-builder.js?v=20260924rb29') || str_contains($settings, 'resume-builder.js?v=20260924rb30'), 'JS cache bust');
