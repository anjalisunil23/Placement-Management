...
class StudentModel extends BaseModel
{
    ...
    public function createProfile(string $userId, array $data): string
    {
        ...
        $doc = [
            ...
            'placementPolicyAccepted' => false,
            'internshipPolicyAccepted' => false,
            'signedReport'     => null,
    ...
    public static function profileToUserFields(?array $profile, ?array $department = null): array
    {
        ...
        return [
            ...
            'policyAccepted' => (bool) ($profile['policyAccepted'] ?? false),
            'policyVersion'  => (string) ($profile['policyVersion'] ?? ''),
            'policyAcceptedAt' => (string) ($profile['policyAcceptedAt'] ?? ''),
            'placementPolicyAccepted' => (bool) ($profile['placementPolicyAccepted'] ?? false),
            'placementPolicyVersion' => (string) ($profile['placementPolicyVersion'] ?? ''),
            'placementPolicyAcceptedAt' => (string) ($profile['placementPolicyAcceptedAt'] ?? ''),
            'internshipPolicyAccepted' => (bool) ($profile['internshipPolicyAccepted'] ?? false),
            'internshipPolicyVersion' => (string) ($profile['internshipPolicyVersion'] ?? ''),
            'internshipPolicyAcceptedAt' => (string) ($profile['internshipPolicyAcceptedAt'] ?? ''),
