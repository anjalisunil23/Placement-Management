...
final class Collections
{
    ...
    public const RESUME_CONTACT_LINKS = 'resume_contact_links';
    ...
    public static function schemas(): array
    {
        return [
            ...
            self::STUDENTS => [
                ...
                'placementPolicyAccepted' => 'bool',
                'placementPolicyAcceptedAt' => 'string',
                'placementPolicyVersion' => 'string',
                'internshipPolicyAccepted' => 'bool',
                'internshipPolicyAcceptedAt' => 'string',
                'internshipPolicyVersion' => 'string',
            ...
            self::STUDENT_VOLUNTEERS => [
                ...
                'academicYear' => 'string (e.g. 2026–2027, July–June)',
                'offerLetter'  => 'object|null (draft/published PCA letter fields)',
            ...
            self::INTERNAL_JOB_POSTS => [
                '_id' => 'ObjectId',
                'jobType' => 'string (part_time|internship)',
                'title' => 'string',
                'company' => 'string',
                'departmentId' => 'string',
                ...
                'duration' => 'string',
                'workingHours' => 'string',
                'stipend' => 'string (part-time, required to publish)',
                'compensationType' => 'string (unpaid|fee|stipend)',
                'compensationAmount' => 'string',
                'paymentFrequency' => 'string (monthly|weekly|one_time)',
                ...
                'createdBy' => 'string',
                'createdByRole' => 'string (admin|placement_officer)',
                'publishedAt' => 'UTCDateTime|null',
                'closedAt' => 'UTCDateTime|null',
                'createdAt' => 'UTCDateTime',
                'updatedAt' => 'UTCDateTime',
            ],
            self::INTERNAL_JOB_APPLICATIONS => [
                '_id' => 'ObjectId',
                'postId' => 'string',
