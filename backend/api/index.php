...
$routes = [
    ...
    ['GET',  '/aptitude/admin/stats',         [AptitudeController::class, 'adminStats']],
    ['GET',  '/aptitude/admin/attempts',      [AptitudeController::class, 'adminAttempts']],
    ['GET',  '/aptitude/tests/available',     [AptitudeController::class, 'listAvailable']],
    ...
    ['GET',  '/aptitude/tests/{id}',          [AptitudeController::class, 'getTest']],
    ['PUT',  '/aptitude/tests/{id}',          [AptitudeController::class, 'updateTest']],
    ['DELETE','/aptitude/tests/{id}',         [AptitudeController::class, 'deleteTest']],
    ['POST', '/aptitude/tests/{id}/archive',  [AptitudeController::class, 'archiveTest']],
    ['POST', '/aptitude/tests/{id}/publish',  [AptitudeController::class, 'publishTest']],
    ['POST', '/aptitude/tests/{id}/unpublish',[AptitudeController::class, 'unpublishTest']],
    ['POST', '/aptitude/tests/{id}/release-results', [AptitudeController::class, 'releaseResults']],
    ...
    ['POST', '/aptitude/question-bank',       [AptitudeController::class, 'createBankQuestion']],
    ['PUT',  '/aptitude/question-bank/{id}',  [AptitudeController::class, 'updateBankQuestion']],
