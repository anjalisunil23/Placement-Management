...
$routes = [
    ...
    ['GET',    '/admin/job-posts/pending',      [AdminController::class, 'listPendingJobPosts']],
    ['DELETE', '/admin/job-posts',              [AdminController::class, 'clearAllJobPosts']],
    ['POST',   '/admin/job-posts/{id}/approve', [AdminController::class, 'approveJobPost']],
    ...
    ['POST',   '/admin/volunteers',             [AdminController::class, 'assignVolunteer']],
    ...
    ['POST',   '/admin/drives/{id}/shortlist-upload', [AdminController::class, 'uploadDriveShortlist']],
    ['GET',    '/admin/drives/{id}/shortlist-document', [AdminController::class, 'downloadDriveShortlistDocument']],
    ...
    ['POST',   '/admin/applications/{id}/shortlist', [AdminController::class, 'shortlistApplication']],
    ['POST',   '/admin/applications/{id}/round-outcome', [AdminController::class, 'setApplicationRoundOutcome']],
    ...
    ['GET',    '/admin/students/{id}/photo',         [AdminController::class, 'studentPhoto']],
    ['GET',    '/admin/students/{id}/pipeline',      [AdminController::class, 'studentPipeline']],
    ['GET',    '/admin/students/{id}/self-placement', [AdminController::class, 'getSelfPlacement']],
    ['POST',   '/admin/students/{id}/self-placement', [AdminController::class, 'createSelfPlacement']],
    ['GET',    '/admin/students/{id}/self-placement/offer-letter', [AdminController::class, 'downloadSelfPlacementOfferLetter']],
    ['GET',    '/admin/students/{id}/self-placement/company-id', [AdminController::class, 'downloadSelfPlacementCompanyId']],
    ['GET',    '/admin/students/{id}/self-placement/salary-slip', [AdminController::class, 'downloadSelfPlacementSalarySlip']],
    ['POST',   '/admin/students/{id}/self-placement/approve', [AdminController::class, 'approveSelfPlacement']],
    ['POST',   '/admin/students/{id}/self-placement/reject', [AdminController::class, 'rejectSelfPlacement']],
    ...
    ['GET',    '/admin/applications/{id}/certificates/{index}', [AdminController::class, 'downloadApplicationCertificate']],
    ...
    ['DELETE', '/admin/placement-news',              [AdminController::class, 'clearAllPlacementNews']],
    ['DELETE', '/admin/placement-news/{id}',         [AdminController::class, 'deletePlacementNews']],
    ['DELETE', '/admin/success-stories',             [AdminController::class, 'clearAllSuccessStories']],
    ['GET',    '/admin/notifications',               [AdminController::class, 'notifications']],
    ['DELETE', '/admin/notifications',               [AdminController::class, 'clearAllSystemNotifications']],
    ...
    ['POST', '/student/placement/history-dates', [StudentController::class, 'updatePlacementHistoryDates']],
    ...
    ['GET',  '/student/resume-builder/projects', [ResumeBuilderController::class, 'listProjects']],
    ...
    ['GET',  '/staff/pca-offer-letters',          [StaffController::class, 'listPcaOfferLetters']],
    ['GET',  '/staff/volunteers/{id}/offer-letter', [StaffController::class, 'getVolunteerOfferLetter']],
    ['GET',  '/staff/jobs',                       [JobFeedController::class, 'staff']],
    ['GET',  '/staff/job-posts',                  [StaffController::class, 'listJobPosts']],
    ['POST', '/staff/job-posts',                  [StaffController::class, 'createJobPost']],
    ...
    ['GET',  '/staff/students/final-year',        [StaffController::class, 'listFinalYearStudents']],
    ['GET',  '/staff/students/placed',            [StaffController::class, 'listPlacedStudents']],
    ['GET',  '/staff/students/{id}/profile',      [StaffController::class, 'studentProfile']],
    ['PUT',  '/staff/students/{id}/profile',      [StaffController::class, 'updateStudentProfile']],
    ['GET',  '/staff/students/{id}/qualifications',[StaffController::class, 'studentQualifications']],
    ...
    ['GET',  '/staff/recruiting',                 [StaffController::class, 'recruitingOverview']],
    ['GET',  '/staff/dashboard-stats',            [StaffController::class, 'dashboardStats']],
    ...
    ['GET',  '/alumni/employment-docs/company-id', [AlumniController::class, 'downloadCompanyIdDoc']],
    ['GET',  '/alumni/employment-docs/salary-slip', [AlumniController::class, 'downloadSalarySlip']],
    ...
    ['GET',  '/alumni/drives/{id}', [AlumniController::class, 'driveDetails']],
    ...
    ['GET',  '/officer/job-posts/pending',         [OfficerController::class, 'listPendingJobPosts']],
    ['POST', '/officer/job-posts/{id}/approve',    [OfficerController::class, 'approveJobPost']],
    ['POST', '/officer/job-posts/{id}/reject',     [OfficerController::class, 'rejectJobPost']],
    ['DELETE', '/officer/job-posts/{id}',          [OfficerController::class, 'deleteJobPost']],
    ...
    ['GET',  '/officer/students/placed',           [OfficerController::class, 'listPlacedStudents']],
    ['GET',  '/officer/students/self-placement/pending', [OfficerController::class, 'listPendingSelfPlacements']],
    ['GET',  '/officer/students/{id}/pipeline',    [OfficerController::class, 'studentPipeline']],
    ['GET',  '/officer/students/{id}/self-placement', [OfficerController::class, 'getSelfPlacement']],
    ['POST', '/officer/students/{id}/self-placement', [OfficerController::class, 'createSelfPlacement']],
    ['GET',  '/officer/students/{id}/self-placement/offer-letter', [OfficerController::class, 'downloadSelfPlacementOfferLetter']],
    ['GET',  '/officer/students/{id}/self-placement/company-id', [OfficerController::class, 'downloadSelfPlacementCompanyId']],
    ['GET',  '/officer/students/{id}/self-placement/salary-slip', [OfficerController::class, 'downloadSelfPlacementSalarySlip']],
    ['POST', '/officer/students/{id}/self-placement/approve', [OfficerController::class, 'approveSelfPlacement']],
    ['POST', '/officer/students/{id}/self-placement/reject', [OfficerController::class, 'rejectSelfPlacement']],
    ['GET',  '/officer/students/pending',          [OfficerController::class, 'pendingStudents']],
    ['GET',  '/officer/students/{id}/profile',     [OfficerController::class, 'studentProfile']],
    ['GET',  '/officer/students/{id}/qualifications', [OfficerController::class, 'studentQualifications']],
    ['GET',  '/officer/students/{id}/photo',       [OfficerController::class, 'studentPhoto']],
    ...
    ['POST', '/officer/applications/{id}/round-outcome', [OfficerController::class, 'setApplicationRoundOutcome']],
    ...
    ['GET',  '/officer/applications/{id}/certificates/{index}', [OfficerController::class, 'downloadApplicationCertificate']],
    ...
    ['GET',  '/officer/drives/{id}/exceptions', [OfficerController::class, 'listDriveExceptions']],
    ['POST', '/officer/drives/{id}/exceptions', [OfficerController::class, 'grantDriveException']],
    ['POST', '/officer/drive-exceptions/{id}/revoke', [OfficerController::class, 'revokeDriveException']],
    ['POST', '/officer/drives/{id}/shortlist-upload', [OfficerController::class, 'uploadDriveShortlist']],
    ['GET',  '/officer/drives/{id}/shortlist-document', [OfficerController::class, 'downloadDriveShortlistDocument']],
    ...
    ['POST', '/aptitude/question-bank/bulk-delete', [AptitudeController::class, 'bulkDeleteBankQuestions']],
    ['GET',  '/aptitude/ai/status',           [AptitudeController::class, 'aiStatus']],
    ['POST', '/aptitude/ai/generate',         [AptitudeController::class, 'generateAiQuestions']],
    ['GET',  '/aptitude/ai/generate-progress', [AptitudeController::class, 'aiGenerateProgress']],
    ...
    ['GET',  '/aptitude/student/jd-sets/{id}', [AptitudeController::class, 'getStudentJdSet']],
    ...
    ['POST', '/coding/tests/{id}/publish-results', [CodingController::class, 'publishResults']],
    ...
    ['POST', '/coding/problem-bank/ai/generate', [CodingController::class, 'generateAiBank']],
